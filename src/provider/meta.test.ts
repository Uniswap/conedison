...
const testCases: [MockJsonRpcProvider, WalletMeta][] = [
    ...
    [new MockInjectedProvider({ isCoinbaseWallet: true, qrUrl: undefined }), { type: WalletType.INJECTED, name: 'CoinbaseWallet'}],
    [new MockInjectedProvider({ isCoinbaseWallet: true, qrUrl: true }), { type: WalletType.INJECTED, name: 'CoinbaseWallet qrUrl'}],
